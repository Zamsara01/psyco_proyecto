...
(4, '8', 'Isabella Ramírez', 'isabella.ramirez@estudiante.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'si', 'activo', '2026-06-03 21:53:14', NULL, NULL, NULL, NULL, NULL, NULL),
...
(6, '10', 'Camila Martínez', 'camila.martinez@estudiante.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'si', 'activo', '2026-06-03 21:53:14', NULL, NULL, NULL, NULL, NULL, NULL),
...
(8, '6', 'Luciana Hernández', 'luciana.hernandez@estudiante.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'si', 'activo', '2026-06-03 21:53:14', NULL, NULL, NULL, NULL, NULL, NULL),
...
(10, '8', 'Sofía Vargas', 'sofia.vargas@estudiante.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'si', 'activo', '2026-06-03 21:53:14', NULL, NULL, NULL, NULL, NULL, NULL),
...
(12, '10', 'Mariana Jiménez', 'mariana.jimenez@estudiante.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'si', 'activo', '2026-06-03 21:53:14', NULL, NULL, NULL, NULL, NULL, NULL),
...
(14, '6', 'Gabriela Sánchez', 'gabriela.sanchez@estudiante.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'si', 'activo', '2026-06-03 21:53:14', NULL, NULL, NULL, NULL, NULL, NULL),
...
(22, '8', 'Melissa Gutiérrez', 'melissa.gutierrez@estudiante.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'si', 'activo', '2026-06-03 21:53:14', NULL, NULL, NULL, NULL, NULL, NULL),
...
(28, '8', 'Carolina Ríos', 'carolina.rios@estudiante.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'si', 'activo', '2026-06-03 21:53:14', NULL, NULL, NULL, NULL, NULL, NULL),
...
(36, '10', 'Verónica Paredes', 'veronica.paredes@estudiante.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'si', 'activo', '2026-06-03 21:53:14', NULL, NULL, NULL, NULL, NULL, NULL),
...
(38, '6', 'Alejandra Ibáñez', 'alejandra.ibanez@estudiante.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'si', 'activo', '2026-06-03 21:53:14', NULL, NULL, NULL, NULL, NULL, NULL),
...
(42, '10', 'Mónica Peña', 'monica.pena@estudiante.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'si', 'activo', '2026-06-03 21:53:14', NULL, NULL, NULL, NULL, NULL, NULL),
...
ALTER TABLE `usuarios` MODIFY `id_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

-- --------------------------------------------------------
-- Tabla: opciones_chatbot
-- --------------------------------------------------------
CREATE TABLE IF NOT EXISTS `opciones_chatbot` (
  ...
  KEY `fk_opcion_padre` (`id_opcion_padre`),
  CONSTRAINT `fk_opcion_padre` FOREIGN KEY (`id_opcion_padre`) REFERENCES `opciones_chatbot` (`id_opcion`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `opciones_chatbot` MODIFY `id_opcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
ALTER TABLE `citas` MODIFY `id_cita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

-- --------------------------------------------------------
-- Tabla: chatbot_interacciones - FK
-- --------------------------------------------------------
...
ALTER TABLE `disponibilidad_psicologos` MODIFY `id_disponibilidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
-- --------------------------------------------------------
-- Tabla: otp_codes (para verificación por correo)
-- --------------------------------------------------------
