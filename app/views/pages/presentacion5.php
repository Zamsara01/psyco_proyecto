        ...
        <div>
            ...
            <ul class="space-y-6">
                <li class="flex items-start gap-4">
                    ...
                    <span class="text-xl md:text-2xl font-semibold text-slate-700" style="font-family: 'Canva Sans', sans-serif;">Facilitar el acceso digital.</span>
                </li>
                <li class="flex items-start gap-4">
                    <span class="text-4xl">📉</span>
                    <span class="text-xl md:text-2xl font-semibold text-slate-700" style="font-family: 'Canva Sans', sans-serif;">Reducir barreras de acceso.</span>
                </li>
                <li class="flex items-start gap-4">
                    <span class="text-4xl">🤝</span>
                    <span class="text-xl md:text-2xl font-semibold text-slate-700" style="font-family: 'Canva Sans', sans-serif;">Fortalecer la confianza institucional.</span>
                </li>
            </ul>
        </div>
...
<div class="fixed bottom-6 right-8 z-[9999] flex items-center gap-4">
    <a id="btn-v5" href="<?= URL_BASE ?>pages/presentacion4" class="inline-flex items-center gap-2 text-white/80 hover:text-white bg-black/40 hover:bg-black/60 px-5 py-2.5 rounded-2xl backdrop-blur-sm border border-white/10 shadow-lg transition-colors">
        <span class="material-symbols-outlined">arrow_back</span><span class="font-bold text-sm">Volver</span>
    </a>
    <a id="btn-s5" href="<?= URL_BASE ?>pages/presentacion6" class="inline-flex items-center gap-2 text-white/80 hover:text-white bg-black/40 hover:bg-black/60 px-5 py-2.5 rounded-2xl backdrop-blur-sm border border-white/10 shadow-lg transition-colors">
