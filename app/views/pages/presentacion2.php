...
<section class="min-h-screen py-16 px-6 bg-nebula flex flex-col items-center justify-center w-full relative">
    ...
    <div class="w-full max-w-6xl mt-6 flex justify-between items-center">
        <a href="<?= URL_BASE ?>pages/presentacion" class="inline-flex items-center gap-2 text-white/80 hover:text-white transition-colors bg-black/20 hover:bg-black/30 px-5 py-2.5 rounded-2xl backdrop-blur-sm">
