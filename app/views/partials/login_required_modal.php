...
<div id="loginRequiredModal" class="fixed inset-0 z-[70] hidden items-center justify-center" role="dialog" aria-modal="true">
    ...
    <div id="loginRequiredCard" class="relative bg-white rounded-3xl shadow-2xl p-8 max-w-sm w-full mx-4 z-10 text-center transform scale-95 transition-all duration-200">
        ...
        <div class="w-20 h-20 rounded-full bg-blue-100 flex items-center justify-center mx-auto mb-5">
            <span class="material-symbols-outlined text-blue-500 text-[42px]">lock</span>
        </div>

        <h3 class="text-xl font-bold text-slate-800 mb-2">Función bloqueada</h3>
        <p class="text-slate-500 text-sm mb-1">Para acceder a</p>
        <p id="loginRequiredFeatureName" class="text-blue-600 font-bold text-base mb-4">esta función</p>
        ...
        <div class="flex flex-col gap-3">
            <button onclick="closeLoginRequiredModal(); openLoginModal();"
                class="w-full py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all active:scale-[0.98] shadow-md shadow-blue-200 flex items-center justify-center gap-2">
                <span class="material-symbols-outlined text-[18px]">login</span>
                Iniciar sesión
            </button>
            <button onclick="closeLoginRequiredModal(); openRegisterModal();"
                class="w-full py-3 border-2 border-blue-200 text-blue-600 font-bold rounded-xl hover:bg-blue-50 transition-all active:scale-[0.98] flex items-center justify-center gap-2">
